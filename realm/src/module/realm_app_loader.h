...
typedef void (*realm_app_update_fn)(void *state, const realm_app_context *ctx, realm_app_cmd_queue *cmds, f64 dt);
typedef void (*realm_app_render_fn)(void *state, const realm_app_context *ctx, realm_app_cmd_queue *cmds);
