...
static inline VkFormat find_supported_format(VK_Context* ctx, VkFormat* candidates, u32 count, VkImageTiling tiling, VkFormatFeatureFlags features) {
    ...
    RL_FATAL("Failed to find supported format for tiling %d and features %x", tiling, features);
    return VK_FORMAT_UNDEFINED;
}

static inline b8 has_stencil_component(VkFormat format) {
